...
|----------|---------------|
| **1. Code Quality** | Clean separation of data / services / utils / components. Reusable primitives. No giant components. |
| **2. Security** | URL allowlist, safe links, no secrets, no XSS vectors. |
| **3. Efficiency** | No unnecessary deps, static local content, 78KB gzip. |
